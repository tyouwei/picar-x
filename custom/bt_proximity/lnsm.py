...
BT_ADDR = '44:f2:1b:99:32:fe'  # You can put your Bluetooth address here.  E.g: 'a4:70:d6:7d:ee:00'
NUM_LOOP = 30
...
def main():
    ...
    A0 = -2.5   #Average RSSI value at d0
    ...
    for i in range(1, num):
        ...
        if True:                    #reduces initial false values of RSSI using initial delay of 10sec
            count=count+1
